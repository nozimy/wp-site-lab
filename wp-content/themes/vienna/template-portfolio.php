				...
				<div class="row">
					...
					<div class="row">
						<div class="portfolioContainer">
							...
							?>
								<!-- Portfolio Loop -->
								<div class="zl_porto_itemwrap large-4 column <?php foreach( $terms as $term ) { echo $term->slug.' '; } ?>">
									<div class="zl_porto_inner">
										...
										<div class="zl_porto_thumb">
											...
											<p class="zl_porto_desc"><?php /*echo substr(get_the_excerpt(), 0,50).'...'*/ if( $terms ){ foreach( $terms as $term ) { echo $term->slug.' '; } }  ?></p>
											<!-- Zoom It -->
											<a href="<?php echo $img_url; ?>" class="portozoom tooltip" rel="portfolio" title="Zoom Image"><span class="dashicons dashicons-editor-expand"></span></a>
											
											<!-- Ajax It -->
											<a href="<?php the_permalink(); ?>" class="ajaxLink portolink tooltip" data-id="<?php the_ID(); ?>" title="View Project"><span class="dashicons dashicons-external"></span></a>
										</div>
									</div>
