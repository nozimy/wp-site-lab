...
/*Featured Content Binding*/
VP_Security::instance()->whitelist_function('featmod_welcome');
function featmod_welcome($value)
{
	if($value === 'welcomessage')
		return true;
	return false;
}
VP_Security::instance()->whitelist_function('featmod_post');
function featmod_post($value)
{
	if($value === 'featuredpost')
		return true;
	return false;
}
...
/*Header Binding*/
VP_Security::instance()->whitelist_function('zl_dep_is_header1');
function zl_dep_is_header1($value)
{
	if($value === 'header1')
		return true;
	return false;
