...
function zl_breadcrumbs() {  
    ...
    /* === OPTIONS === */  
    $text['home']     = zl_option('lang_home', __('Home', 'zatolab')); // text for the 'Home' link  
    ...
    if (is_home() || is_front_page()) {  
        ...
        if ($show_on_home == 1) echo '<ul class="zl_breadcrumbs inline-list"><li><i class="icon-home"></i> <a href="' . $home_link . '">' . $text['home'] . '</a></li></ul>';  
  
    } else {  
  
        echo '<div id="breadcumb" xmlns:v="http://rdf.data-vocabulary.org/#"><ul class="zl_breadcrumbs">';  
        if ($show_home_link == 1) {  
