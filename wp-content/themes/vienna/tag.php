...
$lang_cat = zl_option('lang_tag', __('Tag:','zatolab'));
...
?>
		...
		<div class="row">
			<div class="zl_profilebar singleprofbar">
				<!-- pagination -->
				<div class="medium-6 column postnav">
				...
				<!-- Sorter -->
				<div class="medium-6 column text-right sorter postnav">
		...
		<div class="row text-center">
			<h1 class='zl_arcTitle'> <?php echo $lang_cat; ?> <span><?php printf( __( '%s', 'envalabs' ), single_cat_title( '', false ) ); ?></span></h1>
		</div>
		<!-- oooooooooooooooooooooooooooooooooo
			Post Entries
		oooooooooooooooooooooooooooooooooooo-->
