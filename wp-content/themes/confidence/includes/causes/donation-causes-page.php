	...
	<?php if(get_post_meta( get_the_ID(), 'ninetheme_confidence_m_b_disable_causes', true )){ ?>	
		<div class="col-sm-12 nopadding m_bottom_30_off">
			<div class="charity-box has-margin-xs-bottom">
				...
				<div class="col-sm-3">
					...
					<div class="progress">
						<div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="<?php echo esc_html($slider); ?>" aria-valuemin="0" aria-valuemax="100" style="width:<?php echo esc_html($slider); ?>%">
				...
				<div class="col-sm-3">
					<div class="clearfix">
						<div class="align-center has-margin-xs-right">
