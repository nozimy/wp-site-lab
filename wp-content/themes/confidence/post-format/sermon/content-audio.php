...
<?php $location = rwmb_meta('ninetheme_confidence_m_b_sermon_location', 'type=color'); ?>
    ...
    <?php
		...
		<?php if($sc_url!='') : ?>
		<div class="post-thumb blog-bg-off <?php if ( $date =='' && $manager =='' && $location =='' ) : ?>m-b-30<?php endif; ?>"><?php echo ($soundcloud_audio); ?></div>
		<?php else : ?>
		<div class="post-thumb blog-bg-off <?php if ( $date =='' && $manager =='' && $location =='' ) : ?>m-b-30<?php endif; ?>">
