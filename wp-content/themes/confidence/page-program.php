	...
	*/
	...
	<div class="container has-margin-bottom">
		<div class="row">
			...
			<?php if( ot_get_option( 'programlayout' ) == 'right-sidebar') { ?>
			<div class="col-lg-8 col-md-8 col-sm-12 index float-right posts">
			<?php } elseif( ot_get_option( 'programlayout' ) == 'left-sidebar') { ?>
			
			<div id="widget-area" class="widget-area col-lg-4 col-md-4 col-sm-4">
				<?php if ( is_active_sidebar( 'program-page-sidebar' ) ) { ?>
					<?php dynamic_sidebar( 'program-page-sidebar' ); ?>
				<?php } ?>
			</div>
			<div class="col-lg-8 col-md-8 col-sm-12 index float-left posts">
			<?php } elseif( ot_get_option( 'programlayout' ) == 'full-width') { ?>
			<div class="col-xs-12 full-width-index v">
			<?php } ?>
					  <div id="eventContainer">

						<?php 
							$loop = new WP_Query(array('post_type' => 'program', 'posts_per_page' => -1));
							$count =0;
						?>
						...
						<?php if ( $loop ) : 
							while ( $loop->have_posts() ) : $loop->the_post(); ?>
								...
								<div class="eventsItem">
									<?php get_template_part( 'post-format/program/content', get_post_format() ); ?>
