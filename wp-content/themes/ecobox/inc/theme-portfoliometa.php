...
$meta_box_portfolio = array(
	'id' => 'ecobox-meta-box-portfolio-video',
	'title' => __('Item Info', 'ecobox'),
	'page' => 'portfolio',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
		array(
			"name" => __('Gallery - Gallery IDs','ecobox'),
			"desc" => __('Enter the gallery IDs you created. Example: 9,21','ecobox'),
...
add_action('admin_menu', 'ecobox_add_box_portfolio');
...
function ecobox_add_box_portfolio() {
	global $meta_box_portfolio;

	add_meta_box($meta_box_portfolio['id'], $meta_box_portfolio['title'], 'ecobox_show_box_portfolio_video', $meta_box_portfolio['page'], $meta_box_portfolio['context'], $meta_box_portfolio['priority']);
}
...
function ecobox_show_box_portfolio_video() {
...
add_action('save_post', 'ecobox_save_data_portfolio');
...
function ecobox_save_data_portfolio($post_id) {
	global $meta_box_portfolio;
