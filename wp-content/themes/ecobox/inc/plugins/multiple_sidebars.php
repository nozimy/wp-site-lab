		...
		<div id="sbg_box" class="postbox " >
			...
			<div class="inside">
				<div class="sbg_container">
					...
					<p>Please select the sidebar you would like to display on this page. <strong>Note:</strong> You must first create the sidebar under Appearance > Sidebars. <br>
						Works with <em>Default</em>, <em>Archives</em> page templates and <em>Posts</em>
					</p>
					<ul>
					<?php 
