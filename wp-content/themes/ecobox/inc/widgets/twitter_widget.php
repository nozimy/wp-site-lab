...
class Twitter_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array(
			'classname' => 'twitter',
			'description' => __('The most recent tweets from your feed.', 'ecobox')
		);

		$control_ops = array('id_base' => 'twitter-widget');

		parent::__construct('twitter-widget', 'Ecobox - Twitter Feed', $widget_ops, $control_ops);
	}
	...
	function form($instance)
	{
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('notweets'); ?>"><?php echo _e('Number of Tweets:', 'ecobox') ?></label>
