<?php
/**
 * Gamajoprayers Single Entry Term Body Classes
 *
 * @package   Gamajoprayers_Single_Entry_Term_Body_Classes
 * @author    Gary Jones
 * @license   GPL-2.0+
 * @copyright 2013 Gary Jones, Gamajoprayers Tech
 * @link      http://gamajoprayers.com/single-entry-term-body-classes
 */
 ...
 * @author  Gary Jones
 */
class Gamajoprayers_Single_Entry_Term_Body_Classes {
	...
	public function body_class( $classes ) {
		...
		global $prayers_post_type_registrations;
		return array_merge( $classes, $this->get_taxonomy_term_classes( $prayers_post_type_registrations->taxonomies ) );
	}
