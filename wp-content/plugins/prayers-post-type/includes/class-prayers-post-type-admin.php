...
class Prayers_Post_Type_Admin {
	...
	public function add_thumbnail_column( $columns ) {
		$column_thumbnail = array( 'thumbnail' => __( 'Thumbnail', 'prayers-post-type' ) );
	...
	public function add_glance_counts() {
		$glancer = new Gamajoprayersprayers_Dashboard_Glancer;
	...
	public function add_rightnow_counts() {
		$glancer = new Gamajoprayers_Dashboard_RightNow;
		$glancer->add( $this->registration_handler->post_type, array( 'publish', 'pending' ) );
	}

	/**
	 * Displays the prayers icon in the glance view for version 3.8 and up.
