 ...
 * @author  Gary Jones
 */
class Gamajosermon_Single_Entry_Term_Body_Classes {
	...
	public function body_class( $classes ) {
		...
		global $sermon_post_type_registrations;
		return array_merge( $classes, $this->get_taxonomy_term_classes( $sermon_post_type_registrations->taxonomies ) );
	}
