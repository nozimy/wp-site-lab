 ...
 * @author  Gary Jones
 */
class Gamajoteam_Single_Entry_Term_Body_Classes {
	...
	public function body_class( $classes ) {
		...
		global $team_post_type_registrations;
		return array_merge( $classes, $this->get_taxonomy_term_classes( $team_post_type_registrations->taxonomies ) );
	}
