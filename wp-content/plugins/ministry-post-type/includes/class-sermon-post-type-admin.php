 ...
 * @author  Gary Jones
 */
class Ministry_Post_Type_Admin {
	...
	public function add_thumbnail_column( $columns ) {
		$column_thumbnail = array( 'thumbnail' => __( 'Thumbnail', 'ministry-post-type' ) );
	...
	public function add_glance_counts() {
		$glancer = new Gamajoministry_Dashboard_Glancer;
	...
	public function add_rightnow_counts() {
		$glancer = new Gamajoministry_Dashboard_RightNow;
		$glancer->add( $this->registration_handler->post_type, array( 'publish', 'pending' ) );
	}
