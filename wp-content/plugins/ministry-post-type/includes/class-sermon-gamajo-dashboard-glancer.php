 ...
 * @author  Gary Jones
 */
class Gamajoministry_Dashboard_Glancer {
	...
	public function add( $post_types, $statuses = 'publish' ) {
		...
		if ( did_action( 'dashboard_glance_items' ) ) {
			_doing_it_wrong( __CLASS__, __( 'Trying to add At a Glance items to dashboard widget afterhook already fired', 'Gamajoministry-dashboard-glancer' ), '1.0.0' );
			return;
		}
